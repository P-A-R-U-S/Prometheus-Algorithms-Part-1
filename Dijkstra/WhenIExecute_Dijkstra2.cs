...
namespace Dijkstra
{
    public class WhenIExecute_Dijkstra2
    {
        private readonly Graph<string> _graph;

        public WhenIExecute_Dijkstra2()
        {
        ...
        private void generateGraph1()
        {
            ...
            _graph._graph.Add("e", new List<v>());
        }
        ...
        private void generateGraph2()
        {
            ...
            _graph._graph.Add("6", new List<v>());
        }
        ...
        public void Should_find_minimum_path_for_the_graph_5()
        {
            ...
            _graph.Dijkstra2("1", "6", out _a, out _b);
